...
class VirtualPet:
    ...
    @staticmethod
    def from_dict(data):
        pet = VirtualPet(data['name'], data['age'], data['hunger'], data['happiness'], data['tiredness'], data['health'])
...
class VirtualPetApp:
    ...
    def create_widgets(self):
        ...
        self.play_button = tk.Button(self.root, text="Play", command=self.show_play_buttons, state=tk.DISABLED)  # Judit – 23.07.2024: Show play buttons
        self.play_button.pack()

        self.play_catch_button = tk.Button(self.root, text="Play Catch", command=lambda: self.play("catch"), state=tk.DISABLED)
        self.play_catch_button.pack_forget()  # Judit – 23.07.2024: Hide initially

        self.play_puzzle_button = tk.Button(self.root, text="Play Puzzle", command=lambda: self.play("puzzle"), state=tk.DISABLED)
        self.play_puzzle_button.pack_forget()  # Judit – 23.07.2024: Hide initially

        self.play_dance_button = tk.Button(self.root, text="Play Dance", command=lambda: self.play("dance"), state=tk.DISABLED)
        self.play_dance_button.pack_forget()  # Judit – 23.07.2024: Hide initially
        ...
        self.status_text = tk.Text(self.root, height=5, width=80)  # Judit – 23.07.2024: Reduced height of the status text
    ...
    def show_play_buttons(self):  # Judit – 23.07.2024: Function to show play buttons
